    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 dark:text-black">What Our Clients Say</h2>
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Large quote icon */}
          <div className="absolute -top-10 -left-10 text-amber-200 opacity-50">
            <Quote size={80} />
          </div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white shadow-xl p-8 md:p-12">
                ...
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      ...
                      <h4 className="font-bold text-lg dark:text-black">{testimonial.name}</h4>
                      <p className="text-gray-500 dark:text-gray-600">{testimonial.position}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
            ...
            <button
              onClick={handlePrev}
              className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white shadow-lg flex items-center justify-center text-gray-700 hover:bg-gray-100 transition-colors"
            ...
            <button
              onClick={handleNext}
              className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white shadow-lg flex items-center justify-center text-gray-700 hover:bg-gray-100 transition-colors"
        ...
        <div className="mt-20">
          <div className="text-center mb-12">
            <h3 className="text-2xl font-bold mb-2 dark:text-black">Featured Projects</h3>
